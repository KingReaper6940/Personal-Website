...
SUMMARY
Driven and entrepreneurial Computer Science undergraduate at Penn State University with dual enrollment in Data Science at IIT Madras. Demonstrated leadership through founding tech initiatives, including an AI Club and a conflict-aid organization. Experienced in backend development through internships with Hewlett Packard and Walmart Global Tech. Passionate about machine learning, software development, and ethical AI, with hands-on experience leading real-world projects in home price prediction and mental health tech solutions. Love educating the younger generation about AI and its applications.
...
EXPERIENCE
Software Engineer | Walmart Global Tech | 2024
- Participated in Virtual internship focusing on Inventory management
- Learned Walmart's backend operations and systems
  ...
  const allExperiences = [
    {
      ...
      date: "2024",
      description:
        "Participated in a Virtual internship for Walmart and worked on Inventory management for a duration of two weeks where I learned how Walmart operates behind the scenes.",
    },
    {
    ...
    <div className="min-h-screen bg-gray-900 text-white">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-gray-900/95 backdrop-blur-md border-b border-gray-800">
        <div className="max-w-6xl mx-auto px-6 py-4">
          <div className="flex justify-between items-center">
            <div className="font-bold text-xl bg-gradient-to-r from-blue-400 to-blue-600 bg-clip-text text-transparent">
              Vrishn
            </div>
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12">
            <Button
              ...
              size="lg"
              className="bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white px-8 py-3 rounded-full font-medium transition-all duration-300 transform hover:scale-105 hover:shadow-lg hover:shadow-blue-500/25"
            >
              Explore My Work
            </Button>
            <Button
              ...
              className="border-2 border-gray-600 hover:border-blue-500 text-gray-300 hover:text-white px-8 py-3 rounded-full font-medium transition-all duration-300 bg-transparent hover:scale-105 hover:shadow-lg"
            >
              Get In Touch
            </Button>
          </div>
          ...
          <div className="space-y-8">
            <div className="transform transition-all duration-300 hover:scale-105 hover:-translate-y-2">
              <p className="text-lg text-gray-300 leading-relaxed text-center max-w-4xl mx-auto">
                ...
                AI Club and a conflict-aid organization. Experienced in backend development through internships with
                Hewlett Packard and Walmart Global Tech. Passionate about machine learning, software development, and
                ethical AI, with hands-on experience leading real-world projects in home price prediction and mental
                health tech solutions. I love educating the younger generation about AI and its transformative potential
                in our world.
              </p>
            </div>

            <div className="flex flex-wrap justify-center gap-6 pt-8">
              <div className="flex items-center space-x-3 text-gray-300 transform transition-all duration-300 hover:scale-105 hover:-translate-y-1 hover:text-blue-400">
                <MapPin size={20} className="text-blue-400" />
                <span>University Park, USA</span>
              </div>
              <div className="flex items-center space-x-3 text-gray-300 transform transition-all duration-300 hover:scale-105 hover:-translate-y-1 hover:text-blue-400">
                <Phone size={20} className="text-blue-400" />
                <span>+1 (914) 879-5242</span>
              </div>
              <button
                onClick={handleEmailClick}
                className="flex items-center space-x-3 text-gray-300 transform transition-all duration-300 hover:scale-105 hover:-translate-y-1 hover:text-blue-400"
              >
                <Mail size={20} className="text-blue-400" />
                <span>vrishnviswa.sathyamoorthy@gmail.com</span>
              </button>
            </div>
          </div>
        </div>
      ...
      <section id="education" className="py-20 px-6 bg-gray-800/50">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-8">
            <div className="border-l-4 border-blue-500 pl-8 py-4 transform transition-all duration-300 hover:scale-105 hover:-translate-y-2 hover:shadow-lg hover:shadow-blue-500/10 hover:bg-gray-800/30 rounded-r-lg">
              <div className="flex flex-col md:flex-row md:justify-between md:items-start mb-2">
                <div>
                  <h3 className="text-xl font-semibold text-white">Bachelor of Science in Computer Science</h3>
                  <p className="text-blue-400 font-medium">The Pennsylvania State University</p>
                </div>
            ...
            <div className="border-l-4 border-blue-500 pl-8 py-4 transform transition-all duration-300 hover:scale-105 hover:-translate-y-2 hover:shadow-lg hover:shadow-blue-500/10 hover:bg-gray-800/30 rounded-r-lg">
              <div className="flex flex-col md:flex-row md:justify-between md:items-start mb-2">
                <div>
                  <h3 className="text-xl font-semibold text-white">Bachelor of Science in Data Science</h3>
                  <p className="text-blue-400 font-medium">Indian Institute of Technology, Madras</p>
                </div>
                <div className="flex items-center text-gray-400 mt-2 md:mt-0">
                  <Calendar size={16} className="mr-2" />
                  <span>2024 - 2028 (Expected)</span>
            ...
            <div className="border-l-4 border-blue-500 pl-8 py-4 transform transition-all duration-300 hover:scale-105 hover:-translate-y-2 hover:shadow-lg hover:shadow-blue-500/10 hover:bg-gray-800/30 rounded-r-lg">
              <div className="flex flex-col md:flex-row md:justify-between md:items-start mb-2">
                <div>
                  ...
                  <p className="text-blue-400 font-medium">GEMS Millennium School Sharjah</p>
                </div>
                <div className="flex items-center text-gray-400 mt-2 md:mt-0">
                  <Calendar size={16} className="mr-2" />
                  <span>2019 - 2024</span>
              ...
              <div className="space-y-2 text-gray-300">
                <div className="flex flex-wrap gap-2 items-center">
                  <Badge className="bg-green-600 hover:bg-green-700">CBSE Class XII: 84%</Badge>
                  <Badge className="bg-blue-600 hover:bg-blue-700">CBSE Class X: 88%</Badge>
                  <Badge className="bg-yellow-600 hover:bg-yellow-700">🏆 Centum in AI</Badge>
                </div>
                <p className="mt-2">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-8">
            {displayedExperiences.map((experience, index) => (
              <div
                key={index}
                className="border-l-4 border-blue-500 pl-8 py-4 transform transition-all duration-300 hover:scale-105 hover:-translate-y-2 hover:shadow-lg hover:shadow-blue-500/10 hover:bg-gray-800/30 rounded-r-lg"
              >
                <div className="flex flex-col md:flex-row md:justify-between md:items-start mb-2">
                  <div>
          ...
          {allExperiences.length > 3 && (
            <div className="text-center mt-8">
              <Button
                ...
                variant="outline"
                className="border-2 border-blue-500 text-blue-400 hover:bg-blue-500 hover:text-white px-6 py-2 rounded-full font-medium transition-all duration-300 bg-transparent hover:scale-105 hover:shadow-lg hover:shadow-blue-500/25"
              >
                {showAllExperiences ? (
                  <>
        ...
        <div className="max-w-6xl mx-auto text-center">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
            <div className="group transform transition-all duration-300 hover:scale-105 hover:-translate-y-2">
              <h3 className="text-xl font-semibold mb-6 text-white group-hover:text-blue-400 transition-colors">
          ...
          <div className="mt-16">
            <h3 className="text-2xl font-semibold mb-8 text-white">All Technologies</h3>
            <div className="flex flex-wrap gap-3 justify-center max-w-4xl mx-auto">
              {[
                ...
                return (
                  <div
                    key={index}
                    className={`group relative px-4 py-2 rounded-full bg-gradient-to-r ${
                      categoryColors[tech.category as keyof typeof categoryColors]
                    } text-white font-medium text-sm cursor-pointer transform transition-all duration-300 hover:scale-110 hover:-translate-y-1 hover:shadow-lg hover:shadow-blue-500/25 active:scale-95`}
                  >
          ...
          <div className="mt-12 flex flex-wrap justify-center gap-6">
            {[
              ...
              >
                <div className={`w-4 h-4 rounded-full bg-gradient-to-r ${legend.color}`} />
      ...
      {/* Contact Section */}
      <section id="contact" className="py-20 px-6 bg-gradient-to-r from-blue-600 to-blue-800">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-8">
            <Button
              size="lg"
              variant="secondary"
              className="bg-white text-blue-600 hover:bg-gray-100 px-8 py-3 rounded-full font-medium transform transition-all duration-300 hover:scale-105 hover:shadow-lg"
              onClick={handleEmailClick}
            >
            ...
            <Button
              size="lg"
              variant="outline"
              className="border-2 border-white text-white hover:bg-white hover:text-blue-600 px-8 py-3 rounded-full font-medium transition-all duration-300 bg-transparent hover:scale-105 hover:shadow-lg"
              asChild
            >
      ...
      <footer className="py-8 px-6 bg-black text-center">
        <p className="text-gray-400">© 2024 Vrishn Viswa Sathyamoorthy. Built with Next.js and Tailwind CSS.</p>
      </footer>
    </div>
  )
}
